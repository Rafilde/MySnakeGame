...
public class Jogo extends JFrame {
	...
	private static CenarioPadrao cenario;
	...
	//------------------------------------------------------------------------------------
	public static void changeToRusso() {
		cenario.descarregar();
			...
			if (System.currentTimeMillis() >= prxAtualizacao) {
				...
				if (controleTecla[Tecla.BA.ordinal()]) {
					...
					if (!(cenario instanceof InicioCenario)) {
						...
						cenario = null;
						cenario = new InicioCenario(tela.getWidth(), tela.getHeight());
						//System.out.println(cenario.getFrutinhasComidas()); //aqui eu só to vendo os pontos, depois apaga
						cenario.setFrutinhasComidas(0); //Quando eu retornar para tela inicial os pontos antigos vão zerar
						cenario.carregar();
					}
